...
export function DemoModeBanner() {
  ...
  return (
    <div className={`${status.statusColor} text-white py-2 px-4 text-sm font-medium`}>
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center space-x-3">
          <AlertTriangle className="h-4 w-4" />
          <span>
            You are currently in <strong>Demo Mode</strong>. All data shown is for demonstration purposes only.
          </span>
        </div>
