    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            This action will permanently delete all demo data and switch the system to live mode.
        ...
        <div className="space-y-4">
          {demoStats && (
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <h4 className="font-medium text-yellow-800 mb-2">Demo Data Summary</h4>
              <div className="grid grid-cols-2 gap-2 text-sm text-yellow-700">
                <div>Total Records: {demoStats.totalRecords.toLocaleString()}</div>
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium">
              To confirm, type <code className="bg-gray-100 px-1 rounded">{requiredConfirmText}</code>:
            </label>
            <input
              type="text"
              value={confirmText}
