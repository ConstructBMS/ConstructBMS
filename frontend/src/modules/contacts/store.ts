...
const mockContacts: Contact[] = [
  ...
  },
  {
    ...
    phone: '+1-555-0126',
    companyId: 'comp-3',
    notes: 'Project coordinator for TechCorp Industries.',
    tags: ['coordinator', 'techcorp'],
    createdAt: new Date().toISOString(),
  },
  {
    id: '7',
    ...
    phone: '+1-555-0127',
    notes: 'Structural engineer with expertise in high-rise buildings.',
    tags: ['engineer', 'structural'],
    createdAt: new Date().toISOString(),
  },
];
