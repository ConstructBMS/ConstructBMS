...
import { AlertTriangle, Trash2, Database, Users, FileText, DollarSign } from 'lucide-react';
import { Button } from '../../../components/ui/button';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '../../../components/ui/card';
import { Badge } from '../../../components/ui/badge';
import { DeleteDemoDataModal } from '../../../components/modals/DeleteDemoDataModal';
import { DemoDataService, DemoDataStats } from '../../../services/demo-data.service';
...
export function DemoDataManagement() {
  ...
  const { isDemoMode, canManageDemoData, getDemoModeStatus } = useDemoModeStore();
  ...
  const loadDemoStats = async () => {
    try {
      ...
      setError(err instanceof Error ? err.message : 'Failed to load demo data statistics');
    } finally {
      setIsLoading(false);
    }
  };
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            You don't have permission to manage demo data. Only administrators can perform this action.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <p className="text-yellow-700 text-sm">
              Contact your system administrator if you need to switch to live mode.
            </p>
          </div>
        </CardContent>
      </Card>
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manage demo data and switch between demo and live modes. Demo data is used for testing and demonstration purposes.
          </CardDescription>
        </CardHeader>
            ...
            {isDemoMode ? (
              <div className="space-y-3">
                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <span className="font-medium text-red-800">Switch to Live Mode</span>
                  </div>
                  <p className="text-red-700 text-sm mb-3">
                    This will permanently delete all demo data and switch the system to live mode. 
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="font-medium text-green-800">Live Mode Active</span>
                </div>
                <p className="text-green-700 text-sm">
                  The system is now in live mode. All data is real and production-ready.
                </p>
              </div>
            )}
          </div>
