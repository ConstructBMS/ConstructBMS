...
importers:
  ...
  backend:
    ...
    devDependencies:
      ...
      eslint-plugin-prettier:
        specifier: ^5.0.0
        version: 5.5.4(eslint-config-prettier@9.1.2(eslint@9.34.0(jiti@2.5.1)))(eslint@9.34.0(jiti@2.5.1))(prettier@3.6.2)
      nodemon:
        specifier: ^3.0.2
        version: 3.1.10
      prettier:
  ...
  frontend:
    ...
    devDependencies:
      ...
      vitest:
        specifier: ^3.2.4
        version: 3.2.4(@types/node@20.19.11)(jsdom@26.1.0)
