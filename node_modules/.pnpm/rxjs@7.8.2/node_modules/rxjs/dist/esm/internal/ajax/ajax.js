    ...
    xhr = init.createXHR ? init.createXHR() : new XMLHttpRequest();
    {
      ...
      const addErrorEvent = (type, errorFactory) => {
        xhr.addEventListener(type, () => {
          ...
          (_a =
            progressSubscriber === null || progressSubscriber === void 0
              ? void 0
              : progressSubscriber.error) === null || _a === void 0
            ? void 0
      ...
      const createResponse = (direction, event) =>
        new AjaxResponse(event, xhr, _request, `${direction}_${event.type}`);
        ...
        [LOADSTART, PROGRESS].forEach(type =>
          xhr.upload.addEventListener(type, e => {
            ...
            return (_a =
              progressSubscriber === null || progressSubscriber === void 0
                ? void 0
                : progressSubscriber.next) === null || _a === void 0
              ? void 0
      ...
      xhr.addEventListener(LOAD, event => {
        ...
        if (status < 400) {
          (_a =
            progressSubscriber === null || progressSubscriber === void 0
              ? void 0
              : progressSubscriber.complete) === null || _a === void 0
            ? void 0
          ...
          (_b =
            progressSubscriber === null || progressSubscriber === void 0
              ? void 0
              : progressSubscriber.error) === null || _b === void 0
            ? void 0
...
function extractContentTypeAndMaybeSerializeBody(body, headers) {
  ...
  if (typeof body === 'object') {
    headers['content-type'] =
      (_a = headers['content-type']) !== null && _a !== void 0
        ? _a
