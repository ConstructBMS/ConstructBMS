  ...
  var TestScheduler = (function (_super) {
    ...
    TestScheduler.prototype.createAnimator = function () {
      ...
      var animate = function (marbles) {
        ...
        try {
          for (
            var messages_1 = __values(messages),
            ...
            _this.schedule(function () {
              ...
              try {
                for (
                  var callbacks_1 = ((e_2 = void 0), __values(callbacks)),
    ...
    return new Observable(function (subscriber) {
      ...
      if (outerSignal) {
        if (outerSignal.aborted) {
          ...
          subscriber.add(function () {
            return outerSignal.removeEventListener(
              'abort',
              outerSignalHandler_1
            );
          });
        }
      }
