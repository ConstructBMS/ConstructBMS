...
var TestScheduler = (function (_super) {
  ...
  TestScheduler.prototype.expectObservable = function (
    ...
    this.schedule(function () {
      subscription = observable.subscribe({
        next: function (x) {
          var value =
            x instanceof Observable_1.Observable
    ...
    var _loop_2 = function (i) {
      ...
      switch (c) {
        ...
        case '^':
          ...
          break;
        case '#':
          notification = NotificationFactories_1.errorNotification(
            errorValue || 'error'
          );
          advanceFrameBy(1);
          break;
  ...
  TestScheduler.prototype.run = function (callback) {
    ...
    try {
      ...
      performanceTimestampProvider_1.performanceTimestampProvider.delegate =
        undefined;
    }
  };
