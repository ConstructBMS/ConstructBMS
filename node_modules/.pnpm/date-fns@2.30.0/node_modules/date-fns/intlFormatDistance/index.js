...
function intlFormatDistance(date, baseDate, options) {
  ...
  var rtf = new Intl.RelativeTimeFormat(
    ...
    {
      localeMatcher:
        options === null || options === void 0 ? void 0 : options.localeMatcher,
      numeric:
        (options === null || options === void 0 ? void 0 : options.numeric) ||
        'auto',
