...
var translateSeconds = function translateSeconds(
  _number,
  addSuffix,
  _key,
  isFuture
...
var translateSingular = function translateSingular(
  _number,
  addSuffix,
  key,
  isFuture
...
var formatDistance = function formatDistance(token, count, options) {
  ...
  var isFuture =
    (options === null || options === void 0 ? void 0 : options.comparison) !==
      undefined && options.comparison > 0;
  var result;
