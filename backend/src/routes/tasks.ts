...
router.post(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      const { title, description, priority, assigneeId, projectId, dueDate } =
        req.body;
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      if (updateData.assigneeId)
        transformedData.assignee_id = updateData.assigneeId;
      if (updateData.projectId)
        transformedData.project_id = updateData.projectId;
