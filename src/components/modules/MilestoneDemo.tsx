...
const MilestoneDemo: React.FC = () => {
  ...
  const loadMilestones = async () => {
    try {
      const projectMilestones = await milestoneService.getProjectMilestones(sampleProjectId);
        ...
        <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 bg-gray-50 dark:bg-gray-900">
          <div className="relative" style={{ height: '60px' }}>
            ...
            <div className="flex items-center justify-between mb-2 text-xs text-gray-600 dark:text-gray-400">
              <span>Project Start: {sampleProjectStartDate.toLocaleDateString()}</span>
              <span>Day Width: {dayWidth}px</span>
            </div>
            
            {/* Timeline grid */}
            <div className="relative border-t border-gray-300 dark:border-gray-600" style={{ top: '20px' }}>
              {/* Milestone displays */}
              {milestones.map((milestone) => (
                ...
                >
                  <div
                    ...
                    style={{
                      backgroundColor: milestoneService.getMilestoneColor(milestone),
                      transform: 'rotate(45deg)',
                      border: milestone.isCritical ? '2px solid #dc2626' : '1px solid #1e3a8a'
                    }}
      ...
      <div>
        ...
        {milestones.length === 0 ? (
          <div className="text-center py-8 text-gray-500 dark:text-gray-400">
            ...
            <p className="text-xs mt-1">Click "Add Milestone" to create your first milestone</p>
          </div>
        ) : (
                  ...
                  <div className="flex items-center space-x-3">
                    <div
                      ...
                      style={{
                        backgroundColor: milestoneService.getMilestoneColor(milestone),
                        transform: 'rotate(45deg)',
                        border: milestone.isCritical ? '1px solid #dc2626' : '1px solid #1e3a8a'
                      }}
                    />
                    <div>
