...
const AuditTrailDemo: React.FC<AuditTrailDemoProps> = ({ 
    ...
    const sampleLogs = [
      {
        ...
        before: null,
        after: { name: 'Foundation Excavation', duration: 5, status: 'Not Started' },
  ...
  const generateRandomLogs = async () => {
    ...
    const actionTypes = [
      'task_create', 'task_update', 'task_delete', 'task_move', 'task_resize',
      'dependency_create', 'dependency_delete', 'milestone_create', 'milestone_update',
      'flag_create', 'flag_update', 'flag_delete', 'constraint_set', 'constraint_clear',
      'status_change', 'progress_update', 'resource_assign', 'resource_unassign'
    ];

    const taskNames = [
      'Foundation Work', 'Structural Steel', 'Roofing Installation', 'Electrical Rough-in',
      'Plumbing Installation', 'HVAC Ductwork', 'Interior Finishing', 'Landscaping'
    ];
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Audit Trail Demo</h2>
          ...
          <div className="flex items-start space-x-2">
            ...
            <div className="text-sm text-yellow-800">
              ...
              <ul className="mt-1 space-y-1">
                {auditTrailService.getDemoModeRestrictions().map((restriction, index) => (
      ...
      {/* Sample Task History */}
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Sample Task History</h3>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="space-y-3">
          {demoLogs.length === 0 ? (
            <p className="text-gray-500 text-center py-8">No audit logs yet. Generate some logs to see them here.</p>
          ) : (
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    <h4 className="text-sm font-medium text-gray-900">
                      {auditTrailService.getActionTypeDisplayName(log.actionType)}
                    </h4>
                    {log.demo && (
      ...
      {/* Features Overview */}
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Audit Trail Features</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="p-4 bg-blue-50 rounded-lg">
            ...
            <p className="text-sm text-gray-600 mt-1">
              All timeline changes are automatically logged with before/after states
            </p>
          </div>
          ...
          <div className="p-4 bg-green-50 rounded-lg">
            ...
            <p className="text-sm text-gray-600 mt-1">
              View complete history for individual tasks with detailed change tracking
            </p>
          </div>
          ...
          <div className="p-4 bg-red-50 rounded-lg">
            ...
            <h4 className="font-medium text-gray-900">Permission-Based Access</h4>
            <p className="text-sm text-gray-600 mt-1">
          ...
          <div className="p-4 bg-indigo-50 rounded-lg">
            ...
            <h4 className="font-medium text-gray-900">Statistics & Analytics</h4>
            <p className="text-sm text-gray-600 mt-1">
