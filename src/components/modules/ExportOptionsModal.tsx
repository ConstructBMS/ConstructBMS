...
import { XMarkIcon, DocumentArrowDownIcon, PhotoIcon, Cog6ToothIcon } from '@heroicons/react/24/outline';
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-200px)]">
          ...
          <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900 border border-blue-200 dark:border-blue-700 rounded-lg">
            ...
            <p className="text-sm text-blue-700 dark:text-blue-300">
              Configure your export options below. Settings will be saved for future exports.
            </p>
          </div>
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        const newColumns = e.target.checked
                          ...
                          : options.columnsToInclude.filter(c => c !== column.id);
                        handleOptionChange('columnsToInclude', newColumns);
                      }}
                      disabled={isDemoMode && options.columnsToInclude.length >= 3 && !options.columnsToInclude.includes(column.id)}
              ...
              <div className="space-y-2">
                ...
                <label className="flex items-center space-x-2">
                  <input
                    ...
                    onChange={(e) => handleOptionChange('showLogoHeader', e.target.checked)}
                    className="rounded border-gray-300 dark:border-gray-600 text-blue-600 dark:text-blue-400"
                  />
                  <span className="text-sm text-gray-700 dark:text-gray-300">Show Logo/Header</span>
                </label>
                <label className="flex items-center space-x-2">
                  <input
                    type="checkbox"
              ...
              <div className="flex items-start space-x-2">
                ...
                <div className="text-sm text-yellow-800 dark:text-yellow-200">
                  ...
                  <ul className="mt-1 space-y-1">
                    {exportService.getDemoModeRestrictions().map((restriction, index) => (
