...
const TimelineExportModal: React.FC<TimelineExportModalProps> = ({
  ...
  const [options, setOptions] = useState<TimelineExportOptions>(
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      // Load saved settings
      const savedSettings =
        await timelineExportService.loadExportSettings(projectId);
      if (savedSettings) {
  ...
  const handleSaveSettings = async () => {
    try {
      setError(null);
      const result = await timelineExportService.saveExportSettings(
        projectId,
        options
      );
      if (result.success) {
        ...
        <div className='p-6 overflow-y-auto max-h-[calc(90vh-200px)]'>
          ...
          <div className='mb-6 p-4 bg-blue-50 dark:bg-blue-900 border border-blue-200 dark:border-blue-700 rounded-lg'>
            ...
            <p className='text-sm text-blue-700 dark:text-blue-300'>
              Configure your timeline export options below. Settings will be
              saved for future exports.
            </p>
          </div>
            ...
            <div className='space-y-6'>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={e =>
                    handleOptionChange('zoomLevel', e.target.value)
                  }
                  className='w-full p-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white'
                >
                      ...
                      <input
                        ...
                        value={
                          options.dateRange?.start
                            .toISOString()
                            .split('T')[0] ||
                          currentDateRange.start.toISOString().split('T')[0]
                        }
                        onChange={e =>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={
                          ...
                          currentDateRange.end.toISOString().split('T')[0]
                        }
                        onChange={e =>
                          handleOptionChange('dateRange', {
                            ...options.dateRange,
                ...
                <div className='space-y-2'>
                  <label className='flex items-center space-x-2'>
                    <input
                      ...
                      onChange={e =>
                        handleOptionChange('includeLogo', e.target.checked)
                      }
                      disabled={isDemoMode}
                  ...
                  <div className='space-y-2'>
                    <label className='flex items-center space-x-2'>
                      <input
                        ...
                        onChange={e =>
                          handleOptionChange('multiProject', {
