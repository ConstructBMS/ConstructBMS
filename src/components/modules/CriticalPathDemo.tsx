...
const CriticalPathDemo: React.FC = () => {
  ...
  const [demoConfig, setDemoConfig] = useState(criticalPathService.getDemoModeConfig());
  ...
  const [demoDependencies] = useState<DemoDependency[]>([
    { id: 'dep1', sourceTaskId: '1', targetTaskId: '2', type: 'finish-to-start', lag: 0 },
    { id: 'dep2', sourceTaskId: '2', targetTaskId: '3', type: 'finish-to-start', lag: 0 },
    { id: 'dep3', sourceTaskId: '3', targetTaskId: '4', type: 'finish-to-start', lag: 0 },
    { id: 'dep4', sourceTaskId: '2', targetTaskId: '5', type: 'finish-to-start', lag: 0 },
    { id: 'dep5', sourceTaskId: '4', targetTaskId: '6', type: 'finish-to-start', lag: 0 },
    { id: 'dep6', sourceTaskId: '6', targetTaskId: '7', type: 'finish-to-start', lag: 0 }
  ]);
    ...
    <div className="max-w-6xl mx-auto p-6 space-y-6">
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-1">
              Interactive demonstration of critical path detection and visualization
            </p>
          </div>
          <div className="flex items-center space-x-2">
            <ExclamationTriangleIcon className="w-8 h-8 text-red-500" />
            <span className="text-sm font-medium text-gray-500">Programme Manager v2</span>
          </div>
        </div>
        ...
        {isDemoMode && (
          <div className="bg-pink-50 dark:bg-pink-900/20 border border-pink-200 dark:border-pink-800 rounded-lg p-4 mb-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-medium text-pink-800 dark:text-pink-200">Demo Mode Active</span>
            </div>
            <p className="text-pink-700 dark:text-pink-300 mt-1">
              Limited to {demoConfig.maxCriticalTasks} critical tasks. {demoConfig.watermark}
            </p>
          </div>
        )}
          ...
          <div className="critical-path-info">
            ...
            <div className="critical-path-info-content">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                ...
                <div className="critical-path-stat">
                  <div className="critical-path-stat-value">
                    {demoTasks.filter(t => t.isCritical).reduce((sum, t) => sum + t.duration, 0)}d
                  </div>
                  <div className="critical-path-stat-label">Critical Path Duration</div>
                </div>
                <div className="critical-path-stat">
                  <div className="critical-path-stat-value">
                    {demoTasks.filter(t => !t.isCritical).length}
                  </div>
                  <div className="critical-path-stat-label">Non-Critical Tasks</div>
                </div>
              </div>
            </div>
          </div>
          ...
          {getVisibleTasks().map((task) => (
            <div
              ...
              className={`p-4 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors ${
                showCriticalPath && task.isCritical ? 'critical-path-selected' : ''
              }`}
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex-shrink-0">
                    {task.isMilestone ? (
                      <div className={`w-6 h-6 transform rotate-45 border-2 ${
                ...
                <div className="mt-3 pt-3 border-t border-gray-100 dark:border-gray-700">
                  <div className="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
                    ...
                    {task.dependencies.map((depId, index) => {
                      ...
                      return (
                        <span key={depId} className="text-blue-600 dark:text-blue-400">
                          {depTask?.name}
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <h4 className="font-medium text-gray-900 dark:text-white mb-2">Visual Highlighting</h4>
            <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-400">
          ...
          <div>
            <h4 className="font-medium text-gray-900 dark:text-white mb-2">Interactive Controls</h4>
            <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-400">
          ...
          <div>
            <h4 className="font-medium text-gray-900 dark:text-white mb-2">Demo Mode</h4>
            <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-400">
