...
const CustomDateMarkerButton: React.FC<CustomDateMarkerButtonProps> = ({
  ...
  return (
    <button
      ...
      `}
      title="Add a labelled vertical marker to the timeline"
    >
      <PlusCircleIcon className="w-5 h-5 text-gray-600 dark:text-gray-400" />
      {loading && (
...
export default CustomDateMarkerButton; 