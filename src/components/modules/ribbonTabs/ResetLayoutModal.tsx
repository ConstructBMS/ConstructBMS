      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-xl font-semibold text-gray-900">Reset Layout</h2>
              <p className="text-sm text-gray-500">Reset view layout to defaults</p>
            </div>
          </div>
        ...
        <div className="p-6">
          <div className="space-y-4">
            <div className="bg-yellow-50 p-4 rounded-md">
              <h4 className="text-sm font-medium text-yellow-900 mb-2">Reset Layout Settings</h4>
              <p className="text-sm text-yellow-800">
                This will reset the following layout settings to their default values:
              </p>
              <ul className="text-sm text-yellow-800 mt-2 space-y-1">
                <li>• Pane sizes and positions</li>
                <li>• Collapsed sections</li>
                <li>• Scroll positions</li>
                <li>• Zoom level</li>
                <li>• Split view state</li>
            ...
            {isDemoMode && (
              <div className="bg-blue-50 p-4 rounded-md">
                ...
                <p className="text-sm text-blue-800">
                  Layout changes in demo mode will be reset when switching to live mode.
                </p>
              </div>
            )}
            ...
            <div className="bg-gray-50 p-4 rounded-md">
              ...
              <p className="text-sm text-gray-600">
                This action cannot be undone. All current layout customizations will be lost.
              </p>
            </div>
          </div>
        </div>
