...
const TimelinePrintOptionsModal: React.FC<TimelinePrintOptionsModalProps> = ({
  ...
  const [options, setOptions] = useState<TimelinePrintOptions>(
    timelinePrintService.getDefaultOptions()
  );
  ...
  const handlePreview = async () => {
    try {
      ...
      const result = await timelinePrintService.generatePrintPreview(
        options,
        printData
      );
        ...
        <div className='p-6 space-y-6'>
            ...
            <div className='space-y-3'>
              <label className='flex items-center'>
                <input
                  ...
                  onChange={e =>
                    handleOptionChange('includeProjectHeader', e.target.checked)
                  }
              ...
              <label className='flex items-center'>
                <input
                  ...
                  onChange={e =>
                    handleOptionChange('includeBranding', e.target.checked)
                  }
                  disabled={isDemoMode}
                  className='mr-3 rounded border-gray-300 text-blue-600 focus:ring-blue-500'
                />
              ...
              <label className='flex items-center'>
                <input
                  ...
                  onChange={e =>
                    handleOptionChange('includeFooter', e.target.checked)
                  }
                  className='mr-3 rounded border-gray-300 text-blue-600 focus:ring-blue-500'
                />
              ...
              <label className='flex items-center'>
                <input
                  ...
                  onChange={e =>
                    handleOptionChange('includePageNumbers', e.target.checked)
                  }
                  disabled={isDemoMode}
                  className='mr-3 rounded border-gray-300 text-blue-600 focus:ring-blue-500'
                />
            ...
            <div className='space-y-3'>
              <label className='flex items-center'>
                <input
                  ...
                  onChange={e =>
                    handleOptionChange('timeRange', e.target.value)
                  }
                ...
                <div className='ml-6 grid grid-cols-2 gap-4'>
                  <div>
                    ...
                    <input
                      ...
                      onChange={e =>
                        handleOptionChange('customDateRange', {
            ...
            <div className='space-y-3'>
              <label className='flex items-center'>
                <input
                  ...
                  onChange={e =>
                    handleOptionChange('pageBreaks', e.target.value)
                  }
                  className='mr-3 border-gray-300 text-blue-600 focus:ring-blue-500'
                />
          ...
          <div className='bg-gray-50 p-4 rounded-lg'>
            ...
            <div className='text-sm text-gray-600 space-y-1'>
              ...
              <div>
                Page Size: {options.pageSize} {options.orientation}
              </div>
              {isDemoMode && (
                <div className='text-yellow-600 font-medium'>
                  Demo Mode: Limited to 10 tasks
                </div>
              )}
            </div>
          </div>
