      ...
      <div className="p-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow">
          ...
          {loading ? (
            <div className="p-6 text-center">
              ...
              <p className="mt-2 text-gray-600 dark:text-gray-400">Loading custom fields...</p>
            </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <div>
                          <span className="font-medium">Grid Visible:</span> {field.isVisibleInGrid ? 'Yes' : 'No'}
                        </div>
                        <div>
                          <span className="font-medium">Modal Visible:</span> {field.isVisibleInModal ? 'Yes' : 'No'}
                        </div>
                      </div>
        ...
        <div className="mt-8 bg-blue-50 dark:bg-blue-900 border border-blue-200 dark:border-blue-700 rounded-lg p-6">
          ...
          <div className="space-y-2 text-sm text-blue-800 dark:text-blue-200">
            <p>• <strong>Create Fields:</strong> Use the "Manage Custom Fields" button to add new fields</p>
            <p>• <strong>Field Types:</strong> Choose from Text, Number, Date, or Dropdown</p>
            <p>• <strong>Visibility:</strong> Control whether fields appear in the task grid and/or modal</p>
            <p>• <strong>Required Fields:</strong> Mark fields as required to ensure data entry</p>
            <p>• <strong>Task Entry:</strong> Custom fields appear in the "Custom Fields" tab of task modals</p>
            <p>• <strong>Grid Display:</strong> Fields marked as "Grid Visible" appear as columns in task tables</p>
          </div>
        </div>
      </div>
