...
const TimelineExportDemo: React.FC<TimelineExportDemoProps> = ({
  className = '',
}) => {
            ...
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='text-sm text-gray-600 dark:text-gray-400'>
                  {projectData.client} •{' '}
                  {currentDateRange.start.toLocaleDateString()} -{' '}
          ...
          <div className='overflow-x-auto'>
            <div className='min-w-[800px]'>
              ...
              <div className='grid grid-cols-[300px_1fr] bg-gray-100 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600'>
                <div className='p-3 font-medium text-gray-900 dark:text-white'>
                  Task Name
                </div>
                <div className='p-3 font-medium text-gray-900 dark:text-white'>
                  Timeline
