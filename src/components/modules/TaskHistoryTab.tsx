    ...
    return (
      <div className='text-center py-8'>
        ...
        <p className='text-gray-500'>
          You don't have permission to view task history
        </p>
      </div>
    );
  }
              ...
              <div className='flex items-start space-x-3'>
                ...
                <div className='flex-1 min-w-0'>
                  ...
                  <div className='flex items-center gap-4 text-xs text-gray-500'>
                    <span>By {isDemoMode ? 'Demo User' : 'Unknown User'}</span>
                    <span>•</span>
                    <span>
                      {taskCommentsService.formatTimestamp(entry.createdAt)}
                    </span>
                  </div>
                </div>
              </div>
        ...
        <div className='bg-yellow-50 border border-yellow-200 rounded-md p-3'>
          <div className='flex items-start gap-2'>
            ...
            <div className='text-sm text-yellow-800'>
              ...
              <p className='mt-1'>
                Only the last 3 changes are shown. Upgrade to see full audit
                history.
              </p>
            </div>
          </div>
