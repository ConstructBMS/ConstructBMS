...
import { auditTrailService, AuditLogEntry, AuditLogFilter, AuditLogStats } from '../../services/auditTrailService';
...
const FilterPanel: React.FC<FilterPanelProps> = ({ 
  ...
  const actionTypes = [
    ...
    'structure_change', 'calendar_update'
  ];
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) => onFilterChange({ ...filter, searchKeyword: e.target.value })}
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => onFilterChange({ ...filter, actionType: e.target.value || undefined })}
...
const DiffView: React.FC<DiffViewProps> = ({ before, after, isDemoMode }) => {
  ...
  const renderDiff = () => {
    ...
    if (before && after) {
      ...
      allKeys.forEach(key => {
        ...
        if (beforeVal !== afterVal) {
          if (beforeVal === undefined) {
            changes.push(`<span class="text-green-600">+ ${key}: ${afterVal}</span>`);
          } else if (afterVal === undefined) {
            changes.push(`<span class="text-red-600">- ${key}: ${beforeVal}</span>`);
          } else {
            changes.push(`<span class="text-red-600">- ${key}: ${beforeVal}</span>`);
            changes.push(`<span class="text-green-600">+ ${key}: ${afterVal}</span>`);
          }
      ...
      changes.push(`<span class="text-red-600">- Removed: ${JSON.stringify(before)}</span>`);
    } else if (after) {
      changes.push(`<span class="text-green-600">+ Added: ${JSON.stringify(after)}</span>`);
    }
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-green-50 p-3 rounded-lg">
                      <div className="text-sm font-medium text-gray-900 mb-2">Actions by Type</div>
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex items-start space-x-3 flex-1">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-sm text-gray-600 mt-1">
                                {auditTrailService.formatAuditDescription(log, isDemoMode)}
                              </p>
